...
class AbstractEnv(gym.Env):
    ...
    #PERCEPTION_DISTANCE = 1.0 * Vehicle.MAX_SPEED
    ...
    def __init__(self, config: dict = None, render_mode: str | None = None) -> None:
        ...
        #markchalse 0623
        # 从配置中获取perception_distance_factor，然后乘以MAX_SPEED
        #self.PERCEPTION_DISTANCE = self.config["perception_distance_factor"] * Vehicle.MAX_SPEED
        self.PERCEPTION_DISTANCE = self.config["perception_distance"]  #0623
        ...
        self.ends = [220, 100, 100, 250]  # Before, converging, merge, after
    ...
    def default_config(cls) -> dict:
        ...
        return {
            ...
            "perception_distance_factor": 5.0,  # 默认乘数 #markchalse0623
            "perception_distance":10, #默认距离
        }
